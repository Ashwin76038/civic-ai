    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <img
          ...
          src="https://images.unsplash.com/photo-1557683311-eac922347aa1?auto=format&fit=crop&q=80"
          alt="Control room"
        />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl p-8 text-white">
            <h2 className="text-4xl font-bold mb-4">Administrative Control Center</h2>
            <p className="text-lg">
              Access advanced AI analytics, manage reported issues, and coordinate with municipal departments 
              for efficient resolution of urban infrastructure problems.
            </p>
          </div>
        </div>
      </div>
